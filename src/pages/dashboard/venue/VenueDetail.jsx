...
export const VenueDetail = () => {
  ...
  const [venueAvailibilityModalOpen, setVenueAvailibilityModalOpen] =
    useState(false);
    ...
    <div className={`min-h-screen bg-background`}>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {venueAvailibilityModalOpen && (
          <BookModal
            eventCategory={categories}
            setBookVenueModalOpen={setVenueAvailibilityModalOpen}
          />
        )}
        {venue && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              ...
              <PricingCard
                ...
                details={details}
                setBookVenueModalOpen={setBookVenueModalOpen}
                setVenueAvailibilityModalOpen={setVenueAvailibilityModalOpen}
              />
