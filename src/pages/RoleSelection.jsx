...
import { ArrowRight, Briefcase, Check, Gem, MapPin, Users } from "lucide-react";
import { useNavigate } from "react-router-dom";
...
const roles = [
  {
    ...
    description:
      "Plan and manage your wedding events, invite guests, and book services.",
    icon: Users,
    features: [
  ...
  },
  {
    ...
    description:
      "Offer your services, manage orders, and connect with clients.",
    icon: Briefcase,
    features: [
      "List your services",
      "Set custom pricing",
